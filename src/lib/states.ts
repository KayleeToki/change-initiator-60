...
export const getStateByAbbreviation = (abbreviation: string): string => {
  const state = statesList.find(state => state.abbreviation.toLowerCase() === abbreviation.toLowerCase());
